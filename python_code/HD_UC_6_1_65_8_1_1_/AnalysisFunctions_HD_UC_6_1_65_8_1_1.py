...
import os
#from HD_UC_6_1_65_8_1_1 import name_supports, name_list
#from input_HD_UC_6_1_65_8_1_1 import c_support_names, c_stage_names, mech_properties, points #
...
c_support_names = ['dome_herringbone_6_1_65_8_1_1_0_0.wrl']

c_stage_names = [
    'dome_herringbone_6_1_65_8_1_1_1_1.wrl',
    'dome_herringbone_6_1_65_8_1_1_2_21.wrl',
    'dome_herringbone_6_1_65_8_1_1_22_43.wrl',
    'dome_herringbone_6_1_65_8_1_1_44_65.wrl',
    'dome_herringbone_6_1_65_8_1_1_66_99.wrl',
    ]
...
def names_c_construction(name):
    temp_name_block_group = split_string(name, ['dome_herringbone_6_1_65_8_1_1_','.wrl'])
...
def save_c_state(c_state_name):
    #!heck the path
    state_action = '''
    model save '../../3dec_output/HD_UC_6_1_65_8_1_1_Output/{}' inputdir 
    '''.format(c_state_name)
...
cwd_path = os.getcwd()
path_input('input_HD_UC_6_1_65_8_1_1', cwd_path)
...
for c_stage_name in c_stage_names:
    ...
    if c_stage_name =='dome_herringbone_6_1_65_8_1_1_2_20.wrl':
        coord_point(points[0])
        coord_point(points[1])
        coord_point(points[2])
        coord_point(points[3])
    elif c_stage_name =='dome_herringbone_6_1_65_8_1_1_21_41.wrl':
        coord_point(points[4])
        coord_point(points[5])
    elif c_stage_name =='dome_herringbone_6_1_65_8_1_1_42_62.wrl':
        coord_point(points[6])
        coord_point(points[7])
    elif c_stage_name =='dome_herringbone_6_1_65_8_1_1_66_99.wrl':
    ...
    if c_stage_name == 'dome_herringbone_6_1_65_8_1_1_1_1.wrl':
...
it.command("""
    ...
    model save '../../3dec_output/HD_UC_6_1_65_8_1_1_Output/Complete_dome'
    """)
