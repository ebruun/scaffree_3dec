...
import os
#from HD_UC_6_1_90_20_1_1 import name_supports, name_list
#from input_HD_UC_6_1_90_20_1_1 import c_support_names, c_stage_names, mech_properties, points #
...
c_support_names = ['dome_herringbone_6_1_90_20_1_1_0_0.wrl']

c_stage_names = [
    'dome_herringbone_6_1_90_20_1_1_1_1.wrl',
    'dome_herringbone_6_1_90_20_1_1_2_20.wrl',
    'dome_herringbone_6_1_90_20_1_1_21_41.wrl',
    'dome_herringbone_6_1_90_20_1_1_42_62.wrl',
    'dome_herringbone_6_1_90_20_1_1_63_83.wrl',
    'dome_herringbone_6_1_90_20_1_1_84_104.wrl',
    'dome_herringbone_6_1_90_20_1_1_105_129.wrl',
    ]
...
[4.3332,4.1482,0.1266],
[2.4159,5.4906,0.1266],
[2.3681,5.3819,1.1946],
[4.2474,4.066,1.1946],

[4.0253,3.8534,2.2244],
[2.1234,5.1263,2.283],

[1.9203,4.636,3.2893],
[3.6248,3.47,3.2893],

[3.0791,2.9476,4.2226],
[1.6482,3.9791,4.1774],

[1.3168,3.179,4.9153],
[2.4856,2.3795,4.9153],

[1.8124,1.735,5.4502],
[0.9873,2.2437,5.4764],
[0.5201,1.3375,5.8259],
[1.0366,0.9924,5.8259],
[0.903,0.8644,5.8683],
[0.453,1.165,5.8683]
...
def names_c_construction(name):
    temp_name_block_group = split_string(name, ['dome_herringbone_6_1_90_20_1_1_','.wrl'])
...
def save_c_state(c_state_name):
    #!heck the path
    state_action = '''
    model save '../../3dec_output/HD_UC_6_1_90_20_1_1_Output/{}' inputdir 
    '''.format(c_state_name)
...
cwd_path = os.getcwd()
path_input('input_HD_UC_6_1_90_20_1_1', cwd_path)
...
for c_stage_name in c_stage_names:
    ...
    if c_stage_name =='dome_herringbone_6_1_90_20_1_1_2_20.wrl':
        coord_point(points[0])
        coord_point(points[1])
        coord_point(points[2])
        coord_point(points[3])
    elif c_stage_name =='dome_herringbone_6_1_90_20_1_1_21_41.wrl':
        coord_point(points[4])
        coord_point(points[5])
    elif c_stage_name =='dome_herringbone_6_1_90_20_1_1_42_62.wrl':
        coord_point(points[6])
        coord_point(points[7])
    elif c_stage_name =='dome_herringbone_6_1_90_20_1_1_63_83.wrl':
        coord_point(points[8])
        coord_point(points[9])
    elif c_stage_name =='dome_herringbone_6_1_90_20_1_1_84_104.wrl':
        coord_point(points[10])
        coord_point(points[11])
    elif c_stage_name =='dome_herringbone_6_1_90_20_1_1_105_129.wrl':
    ...
    if c_stage_name == 'dome_herringbone_6_1_90_20_1_1_1_1.wrl':
...
it.command("""
    ...
    model save '../../3dec_output/HD_UC_6_1_90_20_1_1_Output/Complete_dome'
    """)
