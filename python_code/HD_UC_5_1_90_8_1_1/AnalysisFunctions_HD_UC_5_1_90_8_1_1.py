...
import os
#from HD_UC_5_1_90_8_1_1 import name_supports, name_list
#from input_HD_UC_5_1_90_8_1_1 import c_support_names, c_stage_names, mech_properties, points #
...
c_support_names = ['dome_herringbone_5_1_90_8_1_1_0_0.wrl']

c_stage_names = [
    'dome_herringbone_5_1_90_8_1_1_1_1.wrl',
    'dome_herringbone_5_1_90_8_1_1_2_16.wrl',
    'dome_herringbone_5_1_90_8_1_1_17_33.wrl',
    'dome_herringbone_5_1_90_8_1_1_34_50.wrl',
    'dome_herringbone_5_1_90_8_1_1_51_67.wrl',
    'dome_herringbone_5_1_90_8_1_1_68_84.wrl',
    'dome_herringbone_5_1_90_8_1_1_85_104.wrl',
    ]
...
def names_c_construction(name):
    temp_name_block_group = split_string(name, ['dome_herringbone_5_1_90_8_1_1_','.wrl'])
...
def save_c_state(c_state_name):
    #!heck the path
    state_action = '''
    model save '../../3dec_output/HD_UC_5_1_90_8_1_1_Output/{}' inputdir 
    '''.format(c_state_name)
...
cwd_path = os.getcwd()
path_input('input_HD_UC_5_1_90_8_1_1', cwd_path)
...
for c_stage_name in c_stage_names:
    ...
    if c_stage_name == 'dome_herringbone_5_1_90_8_1_1_54_80.wrl':
      it.command("model restore '../../3dec_output/HD_UC_5_1_90_8_1_1_Output/27_53_E_State'") 
    elif c_stage_name == 'dome_herringbone_5_1_90_8_1_1_81_119.wrl':
      it.command("model restore '../../3dec_output/HD_UC_5_1_90_8_1_1_Output/54_80_E_State'")
    model_geometries(c_stage_name,cwd_path)
    if c_stage_name =='dome_herringbone_5_1_90_8_1_1_2_16.wrl':
        coord_point(points[0])
        coord_point(points[1])
        coord_point(points[2])
        coord_point(points[3])
    elif c_stage_name =='dome_herringbone_5_1_90_8_1_1_17_33.wrl':
        coord_point(points[4])
        coord_point(points[5])
    elif c_stage_name =='dome_herringbone_5_1_90_8_1_1_34_50.wrl':
        coord_point(points[6])
        coord_point(points[7])
    elif c_stage_name =='dome_herringbone_5_1_90_8_1_1_51_67.wrl':
        coord_point(points[8])
        coord_point(points[9])
    elif c_stage_name =='dome_herringbone_5_1_90_8_1_1_68_84.wrl':
        coord_point(points[10])
        coord_point(points[11])
    elif c_stage_name =='dome_herringbone_5_1_90_8_1_1_85_104.wrl':
    ...
    if c_stage_name == 'dome_herringbone_5_1_90_8_1_1_1_1.wrl':
...
it.command("""
    ...
    model save '../../3dec_output/HD_UC_5_1_90_8_1_1_Output/Complete_dome'
    """)
